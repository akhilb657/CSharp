...
namespace Basics
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            myGroceryArray[0] = "Sugar";
            myGroceryArray[1] = "Honey";

            // Console.WriteLine(myGroceryArray[0]);
            // Console.WriteLine(myGroceryArray[1]);
            // Console.WriteLine(myGroceryArray[2]);

            string[] mySecondGroceryArray = {"Apples", "Grapes"};
            ...
            List<string> myGroceryList = new List<string>() {"Milk", "Ice cream"};
            ...
            string[,] myTwoDArray = new string[,] {
              {"Apples", "Grapes"},
              {"Milk", "Cheese"}
            };

            // Console.WriteLine(myTwoDArray[1,1]);

            Dictionary<string, string[]> myGroceryDict = new Dictionary<string, string[]>(){
                {"Dairy", new string[]{"Cheese", "Milk", "Eggs"}}
            };

            Console.WriteLine(myGroceryDict["Dairy"][1]);
        }
    }
}